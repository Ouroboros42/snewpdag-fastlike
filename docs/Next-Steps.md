...
[renderers/fastlike](../snewpdag/plugins/renderers/fastlike) contains various plotting nodes to monitor estimators. (These may not be needed in a final implementation).